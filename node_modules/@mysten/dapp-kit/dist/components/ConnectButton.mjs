...
function GettingStarted() {
  return /* @__PURE__ */ jsxs4("div", { className: container4, children: [
    ...
    /* @__PURE__ */ jsxs4("div", { className: content2, children: [
      /* @__PURE__ */ jsx14(InfoSection, { title: "Install the Slush Extension", children: "We recommend pinning Slush to your taskbar for quicker access." }),
...
function WalletListItem({ name, icon, onClick, isSelected = false }) {
  return /* @__PURE__ */ jsx16("li", { className: container7, children: /* @__PURE__ */ jsxs6(
    "button",
    {
      ...
      onClick,
      children: [
        icon && typeof icon === "string" ? /* @__PURE__ */ jsx16("img", { className: walletIcon2, src: icon, alt: `${name} logo` }) : icon,
