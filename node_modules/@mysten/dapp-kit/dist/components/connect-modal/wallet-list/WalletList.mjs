...
function WalletListItem({ name, icon, onClick, isSelected = false }) {
  return /* @__PURE__ */ jsx2("li", { className: container2, children: /* @__PURE__ */ jsxs(
    "button",
    {
...
function WalletList({
  ...
  return /* @__PURE__ */ jsx3("ul", { className: container, children: wallets.length > 0 ? wallets.map((wallet) => /* @__PURE__ */ jsx3(
    WalletListItem,
    {
      name: wallet.name,
      icon: wallet.icon,
