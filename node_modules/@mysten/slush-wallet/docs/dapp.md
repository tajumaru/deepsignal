...
> **Note:** If you are using `dapp-kit`, you do not need to install any additional packages to
> integrate with the Slush wallet. [Read how to integrate with dapp-kit.](/dapp-kit/legacy/slush)
